...
public class UndoLogEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UndoLogEntity)) return false;
        final UndoLogEntity other = (UndoLogEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UndoLogEntity;
    }
    ...
    public String toString() {
        return "UndoLogEntity(id=" + this.getId() + ", branchId=" + this.getBranchId() + ", xid=" + this.getXid() + ", context=" + this.getContext() + ", rollbackInfo=" + java.util.Arrays.toString(this.getRollbackInfo()) + ", logStatus=" + this.getLogStatus() + ", logCreated=" + this.getLogCreated() + ", logModified=" + this.getLogModified() + ", ext=" + this.getExt() + ")";
    }
}
