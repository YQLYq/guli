...
public class UndoLogExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UndoLogExcel)) return false;
        final UndoLogExcel other = (UndoLogExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UndoLogExcel;
    }
    ...
    public String toString() {
        return "UndoLogExcel(id=" + this.getId() + ", branchId=" + this.getBranchId() + ", xid=" + this.getXid() + ", context=" + this.getContext() + ", rollbackInfo=" + java.util.Arrays.toString(this.getRollbackInfo()) + ", logStatus=" + this.getLogStatus() + ", logCreated=" + this.getLogCreated() + ", logModified=" + this.getLogModified() + ", ext=" + this.getExt() + ")";
    }
    //</editor-fold>
}
