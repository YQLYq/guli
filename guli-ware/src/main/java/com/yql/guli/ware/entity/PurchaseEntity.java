...
public class PurchaseEntity {
    ...
    public boolean equals(final Object o) {
        ...
        final PurchaseEntity other = (PurchaseEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PurchaseEntity;
    }
    ...
    public String toString() {
        return "PurchaseEntity(id=" + this.getId() + ", assigneeId=" + this.getAssigneeId() + ", assigneeName=" + this.getAssigneeName() + ", phone=" + this.getPhone() + ", priority=" + this.getPriority() + ", status=" + this.getStatus() + ", wareId=" + this.getWareId() + ", amount=" + this.getAmount() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ")";
    }
}
