...
public class WareOrderTaskEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof WareOrderTaskEntity)) return false;
        final WareOrderTaskEntity other = (WareOrderTaskEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof WareOrderTaskEntity;
    }
