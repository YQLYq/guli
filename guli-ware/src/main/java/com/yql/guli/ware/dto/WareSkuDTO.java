...
public class WareSkuDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof WareSkuDTO)) return false;
        final WareSkuDTO other = (WareSkuDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof WareSkuDTO;
    }
    ...
    public String toString() {
        return "WareSkuDTO(id=" + this.getId() + ", skuId=" + this.getSkuId() + ", wareId=" + this.getWareId() + ", stock=" + this.getStock() + ", skuName=" + this.getSkuName() + ", stockLocked=" + this.getStockLocked() + ")";
    }
    //</editor-fold>
}
