...
public class SkuSaleAttrValueDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SkuSaleAttrValueDTO)) return false;
        final SkuSaleAttrValueDTO other = (SkuSaleAttrValueDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SkuSaleAttrValueDTO;
    }
    ...
    public String toString() {
        return "SkuSaleAttrValueDTO(id=" + this.getId() + ", skuId=" + this.getSkuId() + ", attrId=" + this.getAttrId() + ", attrName=" + this.getAttrName() + ", attrValue=" + this.getAttrValue() + ", attrSort=" + this.getAttrSort() + ")";
    }
    //</editor-fold>
}
