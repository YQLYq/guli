...
public class ProductAttrValueExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ProductAttrValueExcel)) return false;
        final ProductAttrValueExcel other = (ProductAttrValueExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ProductAttrValueExcel;
    }
    ...
    public String toString() {
        return "ProductAttrValueExcel(id=" + this.getId() + ", spuId=" + this.getSpuId() + ", attrId=" + this.getAttrId() + ", attrName=" + this.getAttrName() + ", attrValue=" + this.getAttrValue() + ", attrSort=" + this.getAttrSort() + ", quickShow=" + this.getQuickShow() + ")";
    }
    //</editor-fold>
}
