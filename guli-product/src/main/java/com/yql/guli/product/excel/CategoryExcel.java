...
public class CategoryExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CategoryExcel)) return false;
        final CategoryExcel other = (CategoryExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof CategoryExcel;
    }
    ...
    public String toString() {
        return "CategoryExcel(catId=" + this.getCatId() + ", name=" + this.getName() + ", parentCid=" + this.getParentCid() + ", catLevel=" + this.getCatLevel() + ", showStatus=" + this.getShowStatus() + ", sort=" + this.getSort() + ", icon=" + this.getIcon() + ", productUnit=" + this.getProductUnit() + ", productCount=" + this.getProductCount() + ")";
    }
    //</editor-fold>
}
