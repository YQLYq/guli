...
public class SkuImagesEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SkuImagesEntity)) return false;
        final SkuImagesEntity other = (SkuImagesEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SkuImagesEntity;
    }
    ...
    public String toString() {
        return "SkuImagesEntity(id=" + this.getId() + ", skuId=" + this.getSkuId() + ", imgUrl=" + this.getImgUrl() + ", imgSort=" + this.getImgSort() + ", defaultImg=" + this.getDefaultImg() + ")";
    }
}
