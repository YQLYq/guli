...
public class RefundInfoDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RefundInfoDTO)) return false;
        final RefundInfoDTO other = (RefundInfoDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RefundInfoDTO;
    }
    ...
    public String toString() {
        return "RefundInfoDTO(id=" + this.getId() + ", orderReturnId=" + this.getOrderReturnId() + ", refund=" + this.getRefund() + ", refundSn=" + this.getRefundSn() + ", refundStatus=" + this.getRefundStatus() + ", refundChannel=" + this.getRefundChannel() + ", refundContent=" + this.getRefundContent() + ")";
    }
    //</editor-fold>
}
