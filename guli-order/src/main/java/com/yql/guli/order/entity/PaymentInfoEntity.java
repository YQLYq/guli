...
public class PaymentInfoEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PaymentInfoEntity)) return false;
        final PaymentInfoEntity other = (PaymentInfoEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PaymentInfoEntity;
    }
