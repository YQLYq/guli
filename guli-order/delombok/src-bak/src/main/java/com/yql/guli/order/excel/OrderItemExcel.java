...
public class OrderItemExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OrderItemExcel)) return false;
        final OrderItemExcel other = (OrderItemExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OrderItemExcel;
    }
