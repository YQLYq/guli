...
public class OrderExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OrderExcel)) return false;
        final OrderExcel other = (OrderExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OrderExcel;
    }
