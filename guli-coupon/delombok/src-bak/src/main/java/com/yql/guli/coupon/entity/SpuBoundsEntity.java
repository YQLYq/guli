...
public class SpuBoundsEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SpuBoundsEntity)) return false;
        final SpuBoundsEntity other = (SpuBoundsEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SpuBoundsEntity;
    }
    ...
    public String toString() {
        return "SpuBoundsEntity(id=" + this.getId() + ", spuId=" + this.getSpuId() + ", growBounds=" + this.getGrowBounds() + ", buyBounds=" + this.getBuyBounds() + ", work=" + this.getWork() + ")";
    }
}
