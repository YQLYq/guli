...
public class HomeSubjectEntity {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof HomeSubjectEntity)) return false;
        final HomeSubjectEntity other = (HomeSubjectEntity) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof HomeSubjectEntity;
    }
    ...
    public String toString() {
        return "HomeSubjectEntity(id=" + this.getId() + ", name=" + this.getName() + ", title=" + this.getTitle() + ", subTitle=" + this.getSubTitle() + ", status=" + this.getStatus() + ", url=" + this.getUrl() + ", sort=" + this.getSort() + ", img=" + this.getImg() + ")";
    }
}
