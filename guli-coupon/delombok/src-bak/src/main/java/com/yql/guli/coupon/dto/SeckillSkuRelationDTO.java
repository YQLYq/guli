...
public class SeckillSkuRelationDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SeckillSkuRelationDTO)) return false;
        final SeckillSkuRelationDTO other = (SeckillSkuRelationDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SeckillSkuRelationDTO;
    }
    ...
    public String toString() {
        return "SeckillSkuRelationDTO(id=" + this.getId() + ", promotionId=" + this.getPromotionId() + ", promotionSessionId=" + this.getPromotionSessionId() + ", skuId=" + this.getSkuId() + ", seckillPrice=" + this.getSeckillPrice() + ", seckillCount=" + this.getSeckillCount() + ", seckillLimit=" + this.getSeckillLimit() + ", seckillSort=" + this.getSeckillSort() + ")";
    }
    //</editor-fold>
}
