...
public class HomeAdvDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof HomeAdvDTO)) return false;
        final HomeAdvDTO other = (HomeAdvDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof HomeAdvDTO;
    }
    ...
    public String toString() {
        return "HomeAdvDTO(id=" + this.getId() + ", name=" + this.getName() + ", pic=" + this.getPic() + ", startTime=" + this.getStartTime() + ", endTime=" + this.getEndTime() + ", status=" + this.getStatus() + ", clickCount=" + this.getClickCount() + ", url=" + this.getUrl() + ", note=" + this.getNote() + ", sort=" + this.getSort() + ", publisherId=" + this.getPublisherId() + ", authId=" + this.getAuthId() + ")";
    }
    //</editor-fold>
}
