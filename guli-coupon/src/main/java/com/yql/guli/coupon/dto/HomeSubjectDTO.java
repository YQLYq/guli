...
public class HomeSubjectDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof HomeSubjectDTO)) return false;
        final HomeSubjectDTO other = (HomeSubjectDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof HomeSubjectDTO;
    }
    ...
    public String toString() {
        return "HomeSubjectDTO(id=" + this.getId() + ", name=" + this.getName() + ", title=" + this.getTitle() + ", subTitle=" + this.getSubTitle() + ", status=" + this.getStatus() + ", url=" + this.getUrl() + ", sort=" + this.getSort() + ", img=" + this.getImg() + ")";
    }
    //</editor-fold>
}
