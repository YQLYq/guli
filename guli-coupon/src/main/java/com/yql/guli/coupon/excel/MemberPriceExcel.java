...
public class MemberPriceExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MemberPriceExcel)) return false;
        final MemberPriceExcel other = (MemberPriceExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MemberPriceExcel;
    }
    ...
    public String toString() {
        return "MemberPriceExcel(id=" + this.getId() + ", skuId=" + this.getSkuId() + ", memberLevelId=" + this.getMemberLevelId() + ", memberLevelName=" + this.getMemberLevelName() + ", memberPrice=" + this.getMemberPrice() + ", addOther=" + this.getAddOther() + ")";
    }
    //</editor-fold>
}
