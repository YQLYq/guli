...
public class HomeSubjectSpuExcel {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof HomeSubjectSpuExcel)) return false;
        final HomeSubjectSpuExcel other = (HomeSubjectSpuExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof HomeSubjectSpuExcel;
    }
    ...
    public String toString() {
        return "HomeSubjectSpuExcel(id=" + this.getId() + ", name=" + this.getName() + ", subjectId=" + this.getSubjectId() + ", spuId=" + this.getSpuId() + ", sort=" + this.getSort() + ")";
    }
    //</editor-fold>
}
