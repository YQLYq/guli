<template>
  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px">
      ...
      <el-form-item label="所属分组" prop="attrGroupId" v-if="this.dataForm.attrType == 1">
      ...
      <el-form-item label="可检索" prop="searchType" v-if="this.dataForm.attrType == 1">
        <el-switch
      ...
      <el-form-item label="快速展示" prop="showDesc" v-if="this.dataForm.attrType == 1">
        <el-switch
  ...
  watch: {
    catelogPath(path) {
      ...
      if (path && path.length == 3) {
        this.$axios({
          url: `/product/attrgroup/page/${path[path.length - 1]}`,
          method: "get",
