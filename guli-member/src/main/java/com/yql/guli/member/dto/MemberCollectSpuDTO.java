...
public class MemberCollectSpuDTO implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MemberCollectSpuDTO)) return false;
        final MemberCollectSpuDTO other = (MemberCollectSpuDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MemberCollectSpuDTO;
    }
    ...
    public String toString() {
        return "MemberCollectSpuDTO(id=" + this.getId() + ", memberId=" + this.getMemberId() + ", spuId=" + this.getSpuId() + ", spuName=" + this.getSpuName() + ", spuImg=" + this.getSpuImg() + ", createTime=" + this.getCreateTime() + ")";
    }
    //</editor-fold>
}
