...
public class MemberStatisticsInfoExcel {
    ...
    public MemberStatisticsInfoExcel() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MemberStatisticsInfoExcel)) return false;
        final MemberStatisticsInfoExcel other = (MemberStatisticsInfoExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MemberStatisticsInfoExcel;
    }
