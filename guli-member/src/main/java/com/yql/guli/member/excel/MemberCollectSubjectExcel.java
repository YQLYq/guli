...
public class MemberCollectSubjectExcel {
    ...
    public MemberCollectSubjectExcel() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MemberCollectSubjectExcel)) return false;
        final MemberCollectSubjectExcel other = (MemberCollectSubjectExcel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MemberCollectSubjectExcel;
    }
    ...
    public String toString() {
        return "MemberCollectSubjectExcel(id=" + this.getId() + ", subjectId=" + this.getSubjectId() + ", subjectName=" + this.getSubjectName() + ", subjectImg=" + this.getSubjectImg() + ", subjectUrll=" + this.getSubjectUrll() + ")";
    }
    //</editor-fold>
}
