...
public class IntegrationChangeHistoryDTO implements Serializable {
    ...
    public IntegrationChangeHistoryDTO() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof IntegrationChangeHistoryDTO)) return false;
        final IntegrationChangeHistoryDTO other = (IntegrationChangeHistoryDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof IntegrationChangeHistoryDTO;
    }
    ...
    public String toString() {
        return "IntegrationChangeHistoryDTO(id=" + this.getId() + ", memberId=" + this.getMemberId() + ", createTime=" + this.getCreateTime() + ", changeCount=" + this.getChangeCount() + ", note=" + this.getNote() + ", sourceTyoe=" + this.getSourceTyoe() + ")";
    }
    //</editor-fold>
}
